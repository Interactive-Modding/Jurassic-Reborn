...
//    public static RegistryObject<Item> DEFAULT_BONE = modItems.register("missing_bone", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<RecordItem> JURASSICREBORN_THEME_DISC = MOD_ITEMS.register("disc_jurassicreborn_theme", () -> new RecordItem(101/*dont ask*/, () -> SoundHandler.JURASSICREBORN_THEME, new Item.Properties().tab(TabHandler.ITEMS).rarity(Rarity.RARE)));
    public static final RegistryObject<RecordItem> TROODONS_AND_RAPTORS_DISC = MOD_ITEMS.register("disc_troodons_and_raptors", () -> new RecordItem(102, () -> SoundHandler.TROODONS_AND_RAPTORS, new Item.Properties().tab(TabHandler.ITEMS).rarity(Rarity.RARE)));
    public static final RegistryObject<RecordItem> DONT_MOVE_A_MUSCLE_DISC = MOD_ITEMS.register("disc_dont_move_a_muscle", () -> new RecordItem(103, () -> SoundHandler.DONT_MOVE_A_MUSCLE, new Item.Properties().tab(TabHandler.ITEMS).rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> BIRTHING_WAND = MOD_ITEMS.register("birthing_wand", () -> new UseOnEntityItem(new Item.Properties().tab(TabHandler.ITEMS), interaction -> {
        ...
        if(interaction.getTarget() instanceof DinosaurEntity) {
            ...
            if (dino.isPregnant() && !dino.getDinosaur().isHybrid) {
                ...
                interaction.getPlayer().displayClientMessage(new TranslatableComponent(key), true);            }
        }
        return InteractionResult.FAIL;
    }));
    public static final RegistryObject<Item> PREGNANCY_TEST = MOD_ITEMS.register("pregnancy_test", () -> new UseOnEntityItem(new Item.Properties().tab(TabHandler.ITEMS), (interaction) -> {
        ...
        if(interaction.getTarget() instanceof DinosaurEntity) {//why was this the only one to have a remote check and even then it did it wrong
            DinosaurEntity dino = ((DinosaurEntity)interaction.getTarget());
            interaction.getPlayer().displayClientMessage(new TranslatableComponent("dinosaur.pregnancytest." + (dino.isMale() ? "male" : dino.isPregnant() ? "pregnant" : "not_pregnant")), true);
            return InteractionResult.SUCCESS;
        }
        return InteractionResult.FAIL;
    }));

    public static final RegistryObject<Item> FORD_EXPLORER = MOD_ITEMS.register("ford_explorer", () -> new VehicleSpawnItem(ModEntities.FORD_EXPLORER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> FORD_EXPLORER_SNOW = MOD_ITEMS.register("ford_explorer_snow", () -> new VehicleSpawnItem(ModEntities.FORD_EXPLORER_SNOW, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> MONORAIL = MOD_ITEMS.register("monorail", () -> new VehicleSpawnItem(ModEntities.MONORAIL, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> JEEP_WRANGLER = MOD_ITEMS.register("jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> BLACK_JEEP_WRANGLER = MOD_ITEMS.register("black_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.BLACK_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> BLUE_JEEP_WRANGLER = MOD_ITEMS.register("blue_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.BLUE_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> GREEN_JEEP_WRANGLER = MOD_ITEMS.register("green_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.GREEN_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> LIME_JEEP_WRANGLER = MOD_ITEMS.register("lime_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.LIME_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> PINK_JEEP_WRANGLER = MOD_ITEMS.register("pink_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.PINK_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> PURPLE_JEEP_WRANGLER = MOD_ITEMS.register("purple_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.PURPLE_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> SORNA_JEEP_WRANGLER = MOD_ITEMS.register("sorna_jeep_wrangler", () -> new VehicleSpawnItem(ModEntities.SORNA_JEEP_WRANGLER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> GYROSPHERE = MOD_ITEMS.register("gyrosphere", () -> new VehicleSpawnItem(ModEntities.GYROSPHERE, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));
    public static final RegistryObject<Item> HELICOPTER = MOD_ITEMS.register("helicopter", () -> new VehicleSpawnItem(ModEntities.HELICOPTER, new Item.Properties().stacksTo(1).tab(TabHandler.ITEMS)));

    //WOOD BOATS
    public static final RegistryObject<Item> ARAUCARIA_BOAT = registerBoat("araucaria_boat", ModBoatType.ARAUCARIA);
    public static final RegistryObject<Item> CALAMITES_BOAT = registerBoat("calamites_boat", ModBoatType.CALAMITES);
    public static final RegistryObject<Item> GINKGO_BOAT = registerBoat("ginkgo_boat", ModBoatType.GINKGO);
    public static final RegistryObject<Item> MAGNOLIA_BOAT = registerBoat("magnolia_boat", ModBoatType.MAGNOLIA);
    public static final RegistryObject<Item> PHOENIX_BOAT = registerBoat("phoenix_boat", ModBoatType.PHOENIX);
    public static final RegistryObject<Item> PSARONIUS_BOAT = registerBoat("psaronius_boat", ModBoatType.PSARONIUS);
...
//    }
    ...
    public static void register(IEventBus bus) {
        ...
        for(RegistryObject<Block>/*auto*/ a : ModBlocks.MOD_BLOCKS.getEntries()){
            ...
            if (location.getPath().startsWith("potted_")) {
                continue;
            }
...
//            printAllBonePaths();
    ...
    private static RegistryObject<Item> registerBoat(String name, ModBoatType type) {
        RegistryObject<Item> registryObject = MOD_ITEMS.register(name, () -> new JurassicBoatItem(type,
