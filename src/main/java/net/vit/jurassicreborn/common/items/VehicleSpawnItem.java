...
public class VehicleSpawnItem extends Item {
    ...
    private final Supplier<? extends EntityType<?>> vehicleType;

    public VehicleSpawnItem(Supplier<? extends EntityType<?>> type, Properties props) {
    ...
    public InteractionResult useOn(UseOnContext ctx) {
        ...
        EntityType<?> type = vehicleType.get();
        if (type == null) {
