...
public class LimeJeepWranglerEntity extends VehicleEntity {

    public LimeJeepWranglerEntity(EntityType<? extends VehicleEntity> type, Level level) {
        ...
        protected void dropFromLootTable ( boolean causedByPlayer){
            if (!level().isClientSide) spawnAtLocation(ModItems.LIME_JEEP_WRANGLER.get());
        }
