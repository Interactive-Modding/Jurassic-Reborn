...
public class PinkJeepWranglerEntity extends VehicleEntity {

    public PinkJeepWranglerEntity(EntityType<? extends VehicleEntity> type, Level level) {
        ...
        protected void dropFromLootTable ( boolean causedByPlayer){
            if (!level().isClientSide) spawnAtLocation(ModItems.PINK_JEEP_WRANGLER.get());
        }
