...
public class DinosaurDamageSource extends DamageSource {
    ...
    public Component getLocalizedDeathMessage(LivingEntity pLivingEntity){
        ...
        return MutableComponent.create(
                (stack != null && stack.hasCustomHoverName() && I18n.exists(itemDeathMessage))
                        ? new TranslatableContents(itemDeathMessage, pLivingEntity.getDisplayName(), this.entity.getDisplayName(), stack.getDisplayName())
                        : new TranslatableContents(deathMessage, pLivingEntity.getDisplayName(), this.entity.getDisplayName())
        );
