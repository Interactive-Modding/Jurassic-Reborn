...
public class PurpleJeepWranglerEntity extends VehicleEntity {
    ...
    public PurpleJeepWranglerEntity(EntityType<? extends VehicleEntity> type, Level level) {
        ...
        protected void dropFromLootTable ( boolean causedByPlayer){
            if (!level.isClientSide) spawnAtLocation(ModItems.PURPLE_JEEP_WRANGLER.get());
        }
