...
public class CamarasaurusEntity extends DinosaurEntity implements IHasVariants {
    ...
    public CamarasaurusEntity(EntityType<CamarasaurusEntity> type, Level world) {
        super(world, type, DinosaurHandler.CAMARASAURUS);
