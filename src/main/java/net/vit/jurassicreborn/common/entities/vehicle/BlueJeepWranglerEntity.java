...
public class BlueJeepWranglerEntity extends VehicleEntity {

    public BlueJeepWranglerEntity(EntityType<? extends VehicleEntity> type, Level level) {
        ...
        protected void dropFromLootTable ( boolean causedByPlayer){
            if (!level().isClientSide) spawnAtLocation(ModItems.BLUE_JEEP_WRANGLER.get());
        }
