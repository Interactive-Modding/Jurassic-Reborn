...
public class ProtoceratopsEntity extends DinosaurEntity implements IHasVariants
{
    private static final EntityDataAccessor<Integer> VARIANT= SynchedEntityData.defineId(ProtoceratopsEntity.class, EntityDataSerializers.INT);

    public ProtoceratopsEntity(EntityType<ProtoceratopsEntity> type, Level world)
    {
