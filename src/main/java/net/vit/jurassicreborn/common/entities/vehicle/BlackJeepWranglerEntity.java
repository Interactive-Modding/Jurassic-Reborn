...
public class BlackJeepWranglerEntity extends VehicleEntity {

    public BlackJeepWranglerEntity(EntityType<? extends VehicleEntity> type, Level level) {
        ...
        protected void dropFromLootTable ( boolean causedByPlayer){
            if (!level.isClientSide) spawnAtLocation(ModItems.BLACK_JEEP_WRANGLER.get());
        }
