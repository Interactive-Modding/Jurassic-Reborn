...
public class MicroceratusEntity extends DinosaurEntity implements IHasVariants
{
    private static final EntityDataAccessor<Integer> VARIANT= SynchedEntityData.defineId(MicroceratusEntity.class, EntityDataSerializers.INT);
