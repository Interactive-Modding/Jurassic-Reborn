...
public class OreVeinFeature extends Feature<OreConfiguration> {
                                            ...
                                            if (!bitset.get(l2)) {
                                                ...
                                                if (p_66533_.ensureCanWrite(blockpos$mutableblockpos)) {
                                                    ...
                                                    if (levelchunksection != null) {
                                                        ...
                                                        for(OreConfiguration.TargetBlockState targetState : p_66535_.targetStates){
                                                            if(targetState.target.test(blockstate, rand)){
                                                                if(rand.nextInt(5) == 1){//25% chance, out of 17 roughly 4 should be Plant Fossils
                                                                    if(blockstate.getBlock() != Blocks.DEEPSLATE)
                                                                        levelchunksection.setBlockState(i3, j3, k3, ModBlocks.FLORA_FOSSIL.get().defaultBlockState().setValue(FloraFossil.VARIANT, rand.nextInt(4)), false);
                                                                    else
                                                                        levelchunksection.setBlockState(i3, j3, k3, ModBlocks.DEEPSLATE_FLORA_FOSSIL.get().defaultBlockState().setValue(FloraFossil.VARIANT, rand.nextInt(4)), false);
                                                                }else{
...
//                                                            if (canPlaceOre(blockstate, bulksectionaccess::getBlockState, rand, p_66535_, oreconfiguration$targetblockstate, blockpos$mutableblockpos)) {
