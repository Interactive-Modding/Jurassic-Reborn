...
public class EncasedChasmosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedChasmosaurusFossilBlock(Properties properties) {
        super(properties);
    }
