...
public class EncasedMegatheriumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMegatheriumFossilBlock(Properties properties) {
        super(properties);
    }
