...
public class EncasedLambeosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedLambeosaurusFossilBlock(Properties properties) {
        super(properties);
    }
