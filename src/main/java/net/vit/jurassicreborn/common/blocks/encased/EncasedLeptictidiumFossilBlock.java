...
public class EncasedLeptictidiumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedLeptictidiumFossilBlock(Properties properties) {
        super(properties);
    }
