...
public class EncasedHerrerasaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedHerrerasaurusFossilBlock(Properties properties) {
        super(properties);
    }
