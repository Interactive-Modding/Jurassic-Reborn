...
public class EncasedDeinotheriumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDeinotheriumFossilBlock(Properties properties) {
        super(properties);
    }
