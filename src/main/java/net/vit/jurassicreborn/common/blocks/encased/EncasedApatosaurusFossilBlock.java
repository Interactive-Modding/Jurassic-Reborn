...
public class EncasedApatosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedApatosaurusFossilBlock(Properties properties) {
        super(properties);
    }
