...
public class EncasedMoganopterusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMoganopterusFossilBlock(Properties properties) {
        super(properties);
    }
