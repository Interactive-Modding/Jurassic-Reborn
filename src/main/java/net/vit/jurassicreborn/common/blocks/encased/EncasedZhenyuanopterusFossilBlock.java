...
public class EncasedZhenyuanopterusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedZhenyuanopterusFossilBlock(Properties properties) {
        super(properties);
    }
