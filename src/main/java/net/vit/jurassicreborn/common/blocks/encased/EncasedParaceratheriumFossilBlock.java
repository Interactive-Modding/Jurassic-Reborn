...
public class EncasedParaceratheriumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedParaceratheriumFossilBlock(Properties properties) {
        super(properties);
    }
