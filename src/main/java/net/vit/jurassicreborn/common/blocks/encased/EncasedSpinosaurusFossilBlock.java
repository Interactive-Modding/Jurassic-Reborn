...
public class EncasedSpinosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedSpinosaurusFossilBlock(Properties properties) {
        super(properties);
    }
