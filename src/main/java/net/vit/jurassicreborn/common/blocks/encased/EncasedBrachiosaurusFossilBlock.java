...
public class EncasedBrachiosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedBrachiosaurusFossilBlock(Properties properties) {
        super(properties);
    }
