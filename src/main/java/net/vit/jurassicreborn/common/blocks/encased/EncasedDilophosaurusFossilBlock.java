...
public class EncasedDilophosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDilophosaurusFossilBlock(Properties properties) {
        super(properties);
    }
