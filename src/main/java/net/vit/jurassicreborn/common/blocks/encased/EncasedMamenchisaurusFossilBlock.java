...
public class EncasedMamenchisaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMamenchisaurusFossilBlock(Properties properties) {
        super(properties);
    }
