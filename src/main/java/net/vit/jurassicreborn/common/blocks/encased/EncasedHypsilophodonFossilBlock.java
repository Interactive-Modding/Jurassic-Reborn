...
public class EncasedHypsilophodonFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedHypsilophodonFossilBlock(Properties properties) {
        super(properties);
    }
