...
public class EncasedPostosuchusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedPostosuchusFossilBlock(Properties properties) {
        super(properties);
    }
