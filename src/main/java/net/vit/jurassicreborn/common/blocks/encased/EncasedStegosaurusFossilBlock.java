...
public class EncasedStegosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedStegosaurusFossilBlock(Properties properties) {
        super(properties);
    }
