...
public class EncasedMetriacanthosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMetriacanthosaurusFossilBlock(Properties properties) {
        super(properties);
    }
