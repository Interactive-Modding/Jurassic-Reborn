...
public class EncasedAchillobatorFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAchillobatorFossilBlock(Properties properties) {
        super(properties);
    }
