...
public class EncasedVelociraptorFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedVelociraptorFossilBlock(Properties properties) {
        super(properties);
    }
