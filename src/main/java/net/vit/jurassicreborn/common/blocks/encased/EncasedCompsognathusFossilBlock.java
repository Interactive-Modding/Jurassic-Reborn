...
public class EncasedCompsognathusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCompsognathusFossilBlock(Properties properties) {
        super(properties);
    }
