...
public class EncasedDimorphodonFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDimorphodonFossilBlock(Properties properties) {
        super(properties);
    }
