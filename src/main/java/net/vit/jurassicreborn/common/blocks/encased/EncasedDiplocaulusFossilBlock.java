...
public class EncasedDiplocaulusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDiplocaulusFossilBlock(Properties properties) {
        super(properties);
    }
