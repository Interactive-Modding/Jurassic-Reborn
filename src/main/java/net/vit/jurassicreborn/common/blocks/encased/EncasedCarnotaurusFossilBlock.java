...
public class EncasedCarnotaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCarnotaurusFossilBlock(Properties properties) {
        super(properties);
    }
