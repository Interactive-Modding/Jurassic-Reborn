...
public class EncasedLeaellynasauraFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedLeaellynasauraFossilBlock(Properties properties) {
        super(properties);
    }
