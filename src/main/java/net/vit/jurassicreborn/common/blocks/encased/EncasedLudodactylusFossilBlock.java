...
public class EncasedLudodactylusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedLudodactylusFossilBlock(Properties properties) {
        super(properties);
    }
