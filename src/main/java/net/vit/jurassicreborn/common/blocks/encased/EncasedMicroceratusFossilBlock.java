...
public class EncasedMicroceratusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMicroceratusFossilBlock(Properties properties) {
        super(properties);
    }
