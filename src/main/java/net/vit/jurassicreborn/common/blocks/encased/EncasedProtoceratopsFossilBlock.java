...
public class EncasedProtoceratopsFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedProtoceratopsFossilBlock(Properties properties) {
        super(properties);
    }
