...
public class EncasedGiganotosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedGiganotosaurusFossilBlock(Properties properties) {
        super(properties);
    }
