...
public class EncasedCrassigyrinusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCrassigyrinusFossilBlock(Properties properties) {
        super(properties);
    }
