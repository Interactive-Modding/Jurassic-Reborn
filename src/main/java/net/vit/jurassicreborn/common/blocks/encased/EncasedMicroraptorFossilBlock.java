...
public class EncasedMicroraptorFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMicroraptorFossilBlock(Properties properties) {
        super(properties);
    }
