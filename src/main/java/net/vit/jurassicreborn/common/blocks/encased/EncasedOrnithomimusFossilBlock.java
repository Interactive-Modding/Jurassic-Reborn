...
public class EncasedOrnithomimusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedOrnithomimusFossilBlock(Properties properties) {
        super(properties);
    }
