...
public class EncasedStyracosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedStyracosaurusFossilBlock(Properties properties) {
        super(properties);
    }
