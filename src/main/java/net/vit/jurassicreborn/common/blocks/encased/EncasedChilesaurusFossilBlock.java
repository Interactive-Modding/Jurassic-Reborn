...
public class EncasedChilesaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedChilesaurusFossilBlock(Properties properties) {
        super(properties);
    }
