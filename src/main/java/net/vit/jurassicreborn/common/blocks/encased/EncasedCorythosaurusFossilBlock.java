...
public class EncasedCorythosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCorythosaurusFossilBlock(Properties properties) {
        super(properties);
    }
