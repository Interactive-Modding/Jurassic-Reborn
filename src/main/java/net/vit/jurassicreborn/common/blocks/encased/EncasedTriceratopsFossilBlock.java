...
public class EncasedTriceratopsFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedTriceratopsFossilBlock(Properties properties) {
        super(properties);
    }
