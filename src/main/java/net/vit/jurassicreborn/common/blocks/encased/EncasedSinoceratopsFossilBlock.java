...
public class EncasedSinoceratopsFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedSinoceratopsFossilBlock(Properties properties) {
        super(properties);
    }
