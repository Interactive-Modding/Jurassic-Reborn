...
public class EncasedMajungasaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMajungasaurusFossilBlock(Properties properties) {
        super(properties);
    }
