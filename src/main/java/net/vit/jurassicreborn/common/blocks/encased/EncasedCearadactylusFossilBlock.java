...
public class EncasedCearadactylusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCearadactylusFossilBlock(Properties properties) {
        super(properties);
    }
