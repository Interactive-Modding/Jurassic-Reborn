...
public class EncasedCeratosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCeratosaurusFossilBlock(Properties properties) {
        super(properties);
    }
