...
public class EncasedTyrannosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedTyrannosaurusFossilBlock(Properties properties) {
        super(properties);
    }
