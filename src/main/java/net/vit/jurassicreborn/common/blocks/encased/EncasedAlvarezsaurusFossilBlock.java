...
public class EncasedAlvarezsaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAlvarezsaurusFossilBlock(Properties properties) {
        super(properties);
    }
