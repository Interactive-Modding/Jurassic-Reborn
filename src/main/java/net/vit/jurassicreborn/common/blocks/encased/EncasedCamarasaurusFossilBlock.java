...
public class EncasedCamarasaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCamarasaurusFossilBlock(Properties properties) {
        super(properties);
    }
