...
public class EncasedParapuzosiaFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedParapuzosiaFossilBlock(Properties properties) {
        super(properties);
    }
