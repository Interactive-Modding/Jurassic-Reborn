...
public class EncasedAnkylodocusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAnkylodocusFossilBlock(Properties properties) {
        super(properties);
    }
