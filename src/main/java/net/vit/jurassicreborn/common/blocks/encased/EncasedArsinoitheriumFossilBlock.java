...
public class EncasedArsinoitheriumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedArsinoitheriumFossilBlock(Properties properties) {
        super(properties);
    }
