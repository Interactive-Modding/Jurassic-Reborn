...
public class WoodBlocks {
    ...
    public static final RegistryObject<Block> GINKGO_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("ginkgo_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> GINKGO_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("ginkgo_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> GINKGO_DOOR = ModBlocks.MOD_BLOCKS.register("ginkgo_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> GINKGO_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("ginkgo_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> CALAMITES_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("calamites_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> CALAMITES_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("calamites_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> CALAMITES_DOOR = ModBlocks.MOD_BLOCKS.register("calamites_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> CALAMITES_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("calamites_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> ARAUCARIA_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("araucaria_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> ARAUCARIA_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("araucaria_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> ARAUCARIA_DOOR = ModBlocks.MOD_BLOCKS.register("araucaria_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> ARAUCARIA_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("araucaria_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> PHOENIX_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("phoenix_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> PHOENIX_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("phoenix_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> PHOENIX_DOOR = ModBlocks.MOD_BLOCKS.register("phoenix_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> PHOENIX_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("phoenix_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> PSARONIUS_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("psaronius_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> PSARONIUS_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("psaronius_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> PSARONIUS_DOOR = ModBlocks.MOD_BLOCKS.register("psaronius_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> PSARONIUS_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("psaronius_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
    ...
    public static final RegistryObject<Block> MAGNOLIA_FENCE_GATE = ModBlocks.MOD_BLOCKS.register("magnolia_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE)));
    public static final RegistryObject<Block> MAGNOLIA_PRESSURE_PLATE = ModBlocks.MOD_BLOCKS.register("magnolia_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final RegistryObject<Block> MAGNOLIA_DOOR = ModBlocks.MOD_BLOCKS.register("magnolia_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR)));
    public static final RegistryObject<Block> MAGNOLIA_TRAPDOOR = ModBlocks.MOD_BLOCKS.register("magnolia_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR)));
