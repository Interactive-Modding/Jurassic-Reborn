...
public class EncasedProceratosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedProceratosaurusFossilBlock(Properties properties) {
        super(properties);
    }
