...
public class EncasedPerisphinctesFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedPerisphinctesFossilBlock(Properties properties) {
        super(properties);
    }
