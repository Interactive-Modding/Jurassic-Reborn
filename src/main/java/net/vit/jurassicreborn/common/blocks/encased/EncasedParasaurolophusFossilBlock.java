...
public class EncasedParasaurolophusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedParasaurolophusFossilBlock(Properties properties) {
        super(properties);
    }
