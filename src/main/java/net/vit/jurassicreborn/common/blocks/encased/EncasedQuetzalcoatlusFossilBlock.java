...
public class EncasedQuetzalcoatlusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedQuetzalcoatlusFossilBlock(Properties properties) {
        super(properties);
    }
