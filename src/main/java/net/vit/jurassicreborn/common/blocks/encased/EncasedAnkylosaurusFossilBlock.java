...
public class EncasedAnkylosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAnkylosaurusFossilBlock(Properties properties) {
        super(properties);
    }
