...
public class EncasedTherizinosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedTherizinosaurusFossilBlock(Properties properties) {
        super(properties);
    }
