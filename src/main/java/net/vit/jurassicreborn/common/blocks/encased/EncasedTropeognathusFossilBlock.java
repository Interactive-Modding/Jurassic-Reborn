...
public class EncasedTropeognathusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedTropeognathusFossilBlock(Properties properties) {
        super(properties);
    }
