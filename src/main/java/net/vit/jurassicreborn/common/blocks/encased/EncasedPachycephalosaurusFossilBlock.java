...
public class EncasedPachycephalosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedPachycephalosaurusFossilBlock(Properties properties) {
        super(properties);
    }
