...
public class EncasedDunkleosteusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDunkleosteusFossilBlock(Properties properties) {
        super(properties);
    }
