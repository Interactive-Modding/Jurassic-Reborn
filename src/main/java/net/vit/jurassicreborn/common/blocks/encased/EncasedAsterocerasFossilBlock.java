...
public class EncasedAsterocerasFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAsterocerasFossilBlock(Properties properties) {
        super(properties);
    }
