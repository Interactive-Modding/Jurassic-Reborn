...
public class EncasedMegapiranhaFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedMegapiranhaFossilBlock(Properties properties) {
        super(properties);
    }
