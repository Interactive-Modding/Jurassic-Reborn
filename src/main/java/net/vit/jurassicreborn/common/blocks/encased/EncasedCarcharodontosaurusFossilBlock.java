...
public class EncasedCarcharodontosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedCarcharodontosaurusFossilBlock(Properties properties) {
        super(properties);
    }
