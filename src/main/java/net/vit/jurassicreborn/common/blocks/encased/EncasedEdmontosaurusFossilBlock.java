...
public class EncasedEdmontosaurusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedEdmontosaurusFossilBlock(Properties properties) {
        super(properties);
    }
