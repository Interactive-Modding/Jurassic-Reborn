...
public class EncasedDreadnoughtusFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedDreadnoughtusFossilBlock(Properties properties) {
        super(properties);
    }
