...
public class EncasedSpinoraptorFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedSpinoraptorFossilBlock(Properties properties) {
        super(properties);
    }
