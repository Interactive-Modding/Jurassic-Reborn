...
public class EncasedElasmotheriumFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedElasmotheriumFossilBlock(Properties properties) {
        super(properties);
    }
