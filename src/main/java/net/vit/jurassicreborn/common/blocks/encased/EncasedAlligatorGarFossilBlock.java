...
public class EncasedAlligatorGarFossilBlock extends Block implements EncasedFossil, EntityBlock {
    public EncasedAlligatorGarFossilBlock(Properties properties) {
        super(properties);
    }
