...
public class FossilGrinderCategory implements IRecipeCategory<FossilGrinderRecipeExtension> {
    ...
    public Class<? extends FossilGrinderRecipeExtension> getRecipeClass() {
        return FossilGrinderRecipeExtension.class;
    }
    ...
    public void draw(FossilGrinderRecipeExtension recipe, PoseStack gfx, double mouseX, double mouseY) {
        arrow.draw(gfx, 61, 14);
    }
}
