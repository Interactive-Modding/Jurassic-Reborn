...
public class DNAExtractorCategory implements IRecipeCategory<DNAExtractorRecipeExtension> {
    ...
    public Class<? extends DNAExtractorRecipeExtension> getRecipeClass() {
        return DNAExtractorRecipeExtension.class;
    }
    ...
    public void draw(DNAExtractorRecipeExtension recipe, PoseStack gfx, double mouseX, double mouseY) {
        arrow.draw(gfx, 28, 14);
    }
}
