...
public class DNAHybridizerCategory implements IRecipeCategory<DNAHybridizerRecipeExtension> {
    ...
    public DNAHybridizerCategory(IGuiHelper gui) {
        ...
        this.title = new TranslatableComponent("container.dna_hybridizer");
    ...
    public Class<? extends DNAHybridizerRecipeExtension> getRecipeClass() {
        return DNAHybridizerRecipeExtension.class;
    }
    ...
    public void draw(DNAHybridizerRecipeExtension recipe, PoseStack poseStack, double mouseX, double mouseY) {
        // nothing extra
    }
}
