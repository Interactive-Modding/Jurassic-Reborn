...
public class SoundHandler {
    ...
    public static DeferredRegister<SoundEvent> registrer = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, JurassicReborn.MODID);

    public static final SoundEvent TROODONS_AND_RAPTORS = create("troodons_and_raptors");
    public static final SoundEvent JURASSICREBORN_THEME = create("jurassicreborn_theme");
