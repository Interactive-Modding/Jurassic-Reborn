...
import net.vit.jurassicreborn.common.entities.vehicle.PurpleJeepWranglerEntity;

public class PurpleJeepWranglerRenderer extends CarRenderer<PurpleJeepWranglerEntity> {
    ...
    /* ------------------------------------------------------------------ */
    public PurpleJeepWranglerRenderer(EntityRendererProvider.Context ctx) {
        super(ctx, "purple_jeep_wrangler", makeAnimator());
    }
