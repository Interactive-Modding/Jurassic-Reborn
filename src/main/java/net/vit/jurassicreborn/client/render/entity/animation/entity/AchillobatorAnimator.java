...
public class AchillobatorAnimator extends EntityAnimator<AchillobatorEntity> {
    @Override
    protected void performAnimations(AnimatableModel model, AchillobatorEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
