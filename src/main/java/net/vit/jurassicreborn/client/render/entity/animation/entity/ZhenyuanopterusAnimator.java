...
@OnlyIn(Dist.CLIENT)
public class ZhenyuanopterusAnimator extends EntityAnimator<ZhenyuanopterusEntity>
{
    @Override
    protected void performAnimations(AnimatableModel model, ZhenyuanopterusEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale) {
        ...
        AdvancedModelBox jaw = model.getCube("LowerJaw1");
