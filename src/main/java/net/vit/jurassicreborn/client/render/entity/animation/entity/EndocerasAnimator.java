...
public class EndocerasAnimator extends EntityAnimator<EndocerasEntity> {

    protected void performAnimations(AnimatableModel parModel, EndocerasEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
