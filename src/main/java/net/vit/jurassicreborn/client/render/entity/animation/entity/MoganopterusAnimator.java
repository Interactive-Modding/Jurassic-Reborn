...
{
    @Override
    protected void performAnimations(AnimatableModel model, MoganopterusEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale) {
