...
public class VelociraptorBlueAnimator extends EntityAnimator<VelociraptorBlueEntity> {
    @Override
    protected void performAnimations(AnimatableModel model, VelociraptorBlueEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
