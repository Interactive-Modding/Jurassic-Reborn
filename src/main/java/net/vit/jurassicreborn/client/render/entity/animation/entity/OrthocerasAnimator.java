...
public class OrthocerasAnimator extends EntityAnimator<OrthocerasEntity> {

    protected void performAnimations(AnimatableModel parModel, OrthocerasEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
