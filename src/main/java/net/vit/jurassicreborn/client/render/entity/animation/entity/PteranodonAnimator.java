...
@OnlyIn(Dist.CLIENT)
public class PteranodonAnimator extends EntityAnimator<PteranodonEntity>
{
    @Override
    protected void performAnimations(AnimatableModel model, PteranodonEntity entity, float f, float f1, float ticks, float rotationYaw, float rotationPitch, float scale) {
        ...
        if (entity.isOnGround() && !entity.isCarcass()) {
            ...
            if (!entity.isCarcass()) {
                ...
                // moving vs idle hover (use limb-swing + actual velocity)
