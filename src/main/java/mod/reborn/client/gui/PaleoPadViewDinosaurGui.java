...
public class PaleoPadViewDinosaurGui extends GuiScreen {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(RebornMod.MODID,"textures/gui/paleo_pad/paleo_pad.png");
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.nextPage = new PageButton(0, x + 213, y + 160, true));
        this.buttonList.add(this.previousPage = new PageButton(1, x + 15, y + 160, false));
        this.updateButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.page == 0) {
            ...
            this.drawScaledString(LangUtils.translate(LangUtils.GUI.get("dinosaur_statistics")), statisticsX, y + 14, 1.0F, 0);
            ...
            this.drawBar(statisticsX, y + 75, this.guideInfo.hunger, this.entity.getMetabolism().getMaxEnergy(), 0x94745A);
            this.drawBar(statisticsX, y + 105, this.guideInfo.thirst, this.entity.getMetabolism().getMaxWater(), 0x0000FF);
            ...
            this.drawEntity(x + 65, y + 110, (int) (70 / (dinosaur.getAdultSizeY() + (2 * dinosaur.getScaleAdult() + dinosaur.getPaleoPadScale()))), this.entity);
            ...
            for (String word : text.split(" ")) {
                if (wrapX + (this.fontRenderer.getStringWidth(word)) > 220) {
            ...
            for (String line : lines) {
                this.drawCenteredScaledString(line.trim(), (float)(x + 128 + lineX), (float)lineY, 1.0F, 0);
