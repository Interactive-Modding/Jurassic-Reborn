...
public final class LegArticulator {
    ...
    public static void articulateBiped(DinosaurEntity entity, LegSolverBiped legs, AdvancedModelRenderer body, AdvancedModelRenderer leftThigh, AdvancedModelRenderer leftCalf, AdvancedModelRenderer rightThigh, AdvancedModelRenderer rightCalf, float rotThigh, float rotCalf, float delta) {
    ...
    public static void articulateQuadruped(
        DinosaurEntity entity, LegSolverQuadruped legs, AdvancedModelRenderer body, AdvancedModelRenderer neck,
