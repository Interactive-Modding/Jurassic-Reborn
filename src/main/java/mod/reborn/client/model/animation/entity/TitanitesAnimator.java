...
public class TitanitesAnimator extends EntityAnimator<TitanitesEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, TitanitesEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
