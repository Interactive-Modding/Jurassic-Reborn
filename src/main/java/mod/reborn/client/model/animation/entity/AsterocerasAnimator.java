...
public class AsterocerasAnimator extends EntityAnimator<AsterocerasEntity> {

    protected void performAnimations(AnimatableModel parModel, AsterocerasEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
