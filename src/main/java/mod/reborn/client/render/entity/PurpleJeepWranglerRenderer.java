...
import mod.reborn.server.entity.vehicle.PurpleJeepWranglerEntity;
...
public class PurpleJeepWranglerRenderer extends CarRenderer<PurpleJeepWranglerEntity> {
    ...
    public PurpleJeepWranglerRenderer(RenderManager manager) {
        super(manager, "purple_jeep_wrangler");
    }
