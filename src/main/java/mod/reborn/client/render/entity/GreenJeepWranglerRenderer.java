...
import mod.reborn.server.entity.vehicle.GreenJeepWranglerEntity;
import net.minecraft.client.renderer.entity.RenderManager;
import net.minecraftforge.fml.relauncher.Side;
import net.minecraftforge.fml.relauncher.SideOnly;

@SideOnly(Side.CLIENT)
public class GreenJeepWranglerRenderer extends CarRenderer<GreenJeepWranglerEntity> {

    public GreenJeepWranglerRenderer(RenderManager manager) {
        super(manager, "green_jeep_wrangler");
    }
