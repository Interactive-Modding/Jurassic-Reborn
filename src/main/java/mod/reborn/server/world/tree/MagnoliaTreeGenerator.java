...
public class MagnoliaTreeGenerator extends WorldGenAbstractTree {
    public MagnoliaTreeGenerator() {
        super(true);
    }

    @Override
    public boolean generate(World world, Random rand, BlockPos position) {
        IBlockState log = BlockHandler.ANCIENT_LOGS.get(TreeType.MAGNOLIA).getDefaultState();
        IBlockState leaves = BlockHandler.ANCIENT_LEAVES.get(TreeType.MAGNOLIA).getDefaultState();
