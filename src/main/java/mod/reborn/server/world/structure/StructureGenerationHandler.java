...
public enum StructureGenerationHandler implements IWorldGenerator {
    ...
    public static void register() {
        ...
        StructureGenerationHandler.registerGenerator(JPSanDiegoGenerator::new, StructureUtils.StructureData::isJPSanDiego,(world, pos, random) -> world.getChunkFromBlockCoords(pos)== world.getChunkFromBlockCoords(MapUtils.getJPSanDiegoPosition()));
