...
//        HelicopterEntity helicopter = getHeli(entityPlayer.world, message.heliID);
//        if (helicopter != null) {
...
//    }
//
//    public static HelicopterEntity getHeli(World world, int heliID) {
//        try {
//            return (HelicopterEntity) world.getEntityByID(heliID);
