...
public class DinosaurAttackMeleeEntityAI extends EntityAIBase {
    World world;
    ...
    public boolean shouldContinueExecuting()
    {
        ...
        else if(this.attacker != null && entitylivingbase instanceof DinosaurEntity && ((DinosaurEntity) entitylivingbase).isCarcass() && entitylivingbase.isDead) {
            return false;
        }
        else if (!entitylivingbase.isEntityAlive())
        {
