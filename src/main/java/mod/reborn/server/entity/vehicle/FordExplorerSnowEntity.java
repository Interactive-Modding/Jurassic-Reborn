...
import mod.reborn.server.message.FordExplorerChangeStateMessage;
import mod.reborn.server.message.FordExplorerUpdatePositionStateMessage;
...
public class FordExplorerSnowEntity extends VehicleEntity {
    ...
    public void dropItems() {
        this.entityDropItem(new ItemStack(ItemHandler.VEHICLE_ITEM, 1, 3), 0);
    }
    ...
    public void onUpdate() {
        ...
        if(!world.isRemote) {
            ...
            if(onRails != isRails) {
                ...
                onRails = isRails;
                RebornMod.NETWORK_WRAPPER.sendToDimension(new FordExplorerSnowChangeStateMessage(this), world.provider.getDimension());
            }
            this.railTracks = isRails ? rail : INACTIVE;
            if(!this.railTracks.equals(prevRailTracks)) {
                RebornMod.NETWORK_WRAPPER.sendToDimension(new FordExplorerSnowUpdatePositionStateMessage(this, rail), world.provider.getDimension());
            }
...
//			this.stepHeight = 1.5F;
    ...
    public class MinecartLogic {
        ...
        private void moveMinecartOnRail() {
            ...
            FordExplorerSnowEntity.this.move(MoverType.SELF, mX, 0D, mZ);
        }
