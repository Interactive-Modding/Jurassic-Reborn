    ...
    public void onUpdate() {
        ...
        if(!world.isRemote) {
            ...
            if(onRails != isRails) {
                ...
                onRails = isRails;
                RebornMod.NETWORK_WRAPPER.sendToDimension(new FordExplorerChangeStateMessage(this), world.provider.getDimension());
            }
            this.railTracks = isRails ? rail : INACTIVE;
            if(!this.railTracks.equals(prevRailTracks)) {
                RebornMod.NETWORK_WRAPPER.sendToDimension(new FordExplorerUpdatePositionStateMessage(this, rail), world.provider.getDimension());
            }
