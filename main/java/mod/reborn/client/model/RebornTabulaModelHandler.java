...
public enum RebornTabulaModelHandler implements ICustomModelLoader, JsonDeserializationContext {
    INSTANCE;
    ...
    public void addDomain(String domain) {
        ...
        LLibrary.LOGGER.info("RebornTabulaModelHandler: Domain {} has been added.", domain.toLowerCase(Locale.ROOT));
    }
    ...
    public boolean accepts(ResourceLocation modelLocation) {
        return this.enabledDomains.contains(modelLocation.getResourceDomain()) && modelLocation.getResourcePath().endsWith(".tbl_rebornmod");
    }
    ...
    public IModel loadModel(ResourceLocation modelLocation) throws IOException {
        ...
        return new RebornVanillaTabulaModel(modelJson, particle != null ? new ResourceLocation(particle) : null, builder.build(), PerspectiveMapWrapper.getTransforms(modelBlock.getAllTransforms()));
    }
